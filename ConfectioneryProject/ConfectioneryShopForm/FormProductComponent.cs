...
namespace ConfectioneryShopForm {
    public partial class FormProductComponent : Form {
        ...
        public ConnectionBetweenComponentAndProductViewModel Model {
            set { model = value; }
            get {
                return model;
            }
        ...
        private ConnectionBetweenComponentAndProductViewModel model;
        ...
        private void save_Button_Click(object sender, EventArgs e) {
            ...
            try {
                if (model == null) {
                    model = new ConnectionBetweenComponentAndProductViewModel {
