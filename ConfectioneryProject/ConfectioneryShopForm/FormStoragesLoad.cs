...
namespace ConfectioneryShopForm {
    public partial class FormStoragesLoad : Form {
        ...
        private void FormStoragesLoad_Load(object sender, EventArgs e) {
            try {
                var dict = APICustomer.GetRequest<List<StorageLoadViewModel>>("api/Report/GetStoresLoad");
        ...
        private void buttonSaveToExcel_Click(object sender, EventArgs e) {
            ...
            if ( sfd.ShowDialog() == DialogResult.OK ) {
                try {
                    APICustomer.PostRequest<ReportBindingModel, bool>("api/Report/SaveStoresLoad",
