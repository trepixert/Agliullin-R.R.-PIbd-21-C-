...
namespace ConfectioneryShopForm {
    public partial class FormProduct : Form {
        ...
        private int? id;
        private List<ConnectionBetweenComponentAndProductViewModel> productComponents;
        ...
        private void FormProduct_Load(object sender, EventArgs e) {
            if (id.HasValue) {
                ...
                productComponents = new List<ConnectionBetweenComponentAndProductViewModel>();
            }
        }
        ...
        private void save_Button_Click(object sender, EventArgs e) {
            ...
            try {
                List<ConnectionBetweenComponentAndProduct> productComponentBM = new
               List<ConnectionBetweenComponentAndProduct>();
                for (int i = 0; i < productComponents.Count; ++i) {
                    productComponentBM.Add(new ConnectionBetweenComponentAndProduct{
                ...
                if (id.HasValue) {
                    service.updElem(new ProductBindingModel {
                        ID = id.Value,
                        ProductName = textBoxName.Text,
                        Price = Convert.ToInt32(textBoxPrice.Text),
                        ProductComponent = productComponentBM
                    });
                } else {
                    service.addElem(new ProductBindingModel {
                        ProductName = textBoxName.Text,
                        Price = Convert.ToInt32(textBoxPrice.Text),
                        ProductComponent = productComponentBM
                    });
