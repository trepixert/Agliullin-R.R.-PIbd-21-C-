...
namespace ConfectioneryShopImplement.Implementations {
    public class OutputServiceList : IOutputService {
        ...
        public void AddElem(OutputBindingModel model) {
            ...
            int maxPCId = source.DetailOutputs.Count > 0 ? source.DetailOutputs.Max(rec => rec.ID) : 0;
            ...
            foreach ( var groupComponent in groupComponents ) {
                source.DetailOutputs.Add(new ConnectionBetweenDetailAndOutput {
                    ID = ++maxPCId,
                    OutputID = maxId + 1,
        ...
        public void UpdElem(OutputBindingModel model) {
            ...
            foreach ( var groupComponent in groupComponents ) {
                ConnectionBetweenDetailAndOutput elementPC = source.DetailOutputs.FirstOrDefault(
                rec
